...
if (isset($_POST)) {
    ...
    if (!empty($_POST["inscripcion_id"])) {
        ...
        $mysqli = $conexion->prepare("UPDATE inscripciones SET status = 0 WHERE id = ?");
        ...
        $datos = [
            ...
            "texto" => $mysqli->affected_rows > 0 ? "La inscripción se ha cancelado correctamente." : "No se pudo cancelar la inscripción.",
