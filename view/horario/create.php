...
$titulo = "Crear horario para " . $clase->nombre_asignatura . " - " . $clase->carrera_id . " " . $clase->nombre_sistema;
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select form-select-lg rounded-0 border-2" name="dia_id" id="dia_id">
                            ...
                            while ($dia = $sql->fetch_object()) : ?>
                                <option value="<?= $dia->id ?>"><?= $dia->nombre_id ?></option>
                            <?php endwhile; ?>
                        </select>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="hora_inicio" class="form-label">Hora inicio</label>
                        <input type="time" class="form-control form-control-lg rounded-0 border-2" name="hora_inicio" id="hora_inicio">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="hora_fin" class="form-label">Hora fin</label>
                        <input type="time" class="form-control form-control-lg rounded-0 border-2" name="hora_fin" id="hora_fin">
                    </div>
                </div>
                <div class="mb-3">
                    <button type="submit" class="btn btn-lg btn-primary rounded-0 text-uppercase">Registrar horario</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="<?= URL_RAIZ ?>js/horario/app-create.js"></script>
