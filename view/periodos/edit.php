...
<div class="col-md-9 col-lg-10 ms-sm-auto px-4 main-content">
    ...
    $pr = $conexion->prepare("SELECT * FROM periodos WHERE id = ? LIMIT 1");
    $pr->bind_param("i", $id);
    $pr->execute();
        ...
        <form method="post" id="form_periodo">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control form-control-lg rounded-0 border-2" type="date" name="fecha_inicio" id="fecha_inicio" placeholder="Fecha de Inicio..." value="<?= $edit->fecha_inicio ?>">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label" for="fecha_fin">Fecha de Fin</label>
                    <input class="form-control form-control-lg rounded-0 border-2" type="date" name="fecha_fin" id="fecha_fin" placeholder="Fecha de Fin..." value="<?= $edit->fecha_fin ?>">
                </div>
                <div class="col-md-6 mb-3">
...
<script src="<?= URL_RAIZ ?>js/periodos/app-edit.js"></script>
