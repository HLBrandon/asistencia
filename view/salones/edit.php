...
<div class="col-md-9 col-lg-10 ms-sm-auto px-4 main-content">
    ...
    $pr = $conexion->prepare("SELECT * FROM salones WHERE id = ? LIMIT 1");
    $pr->bind_param("s", $id);
    $pr->execute();
    ...
    <form method="post" id="form_salon">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input class="form-control form-control-lg rounded-0 border-2" type="text" name="nombre_salon" id="nombre_salon" placeholder="Nombre del salón..." value="<?= $edit->nombre_salon ?>">
            </div>
...
<script src="<?= URL_RAIZ ?>js/salones/app-edit.js"></script>
