...
<div class="col-md-9 col-lg-10 ms-sm-auto px-4 main-content">
    ...
    $pr = $conexion->prepare("SELECT * FROM usuarios WHERE id = ? LIMIT 1");
    $pr->bind_param("i", $id);
    $pr->execute();
        ...
        <form method="post" id="form_usuario">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control form-control-lg rounded-0 border-2" type="text" name="apellido_paterno" id="apellido_paterno" placeholder="Apellido paterno..." value="<?= $edit->apellido_paterno ?>">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label" for="apellido_materno">Apellido Materno</label>
                    <input class="form-control form-control-lg rounded-0 border-2" type="text" name="apellido_materno" id="apellido_materno" placeholder="Apellido materno..." value="<?= $edit->apellido_materno ?>">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label" for="correo">Correo</label>
                    <input class="form-control form-control-lg rounded-0 border-2" type="email" name="correo" id="correo" placeholder="Email@example.com" value="<?= $edit->correo ?>">
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select form-select-lg rounded-0 border-2" name="role_id" id="role_id">
                        ...
                        ?>
                            <option <?= ($dato->id == $edit->role_id) ? 'selected' : '' ?> value="<?= $dato->id ?>"><?= $dato->nombre_role ?></option>
                        <?php endwhile; ?>
                    </select>
                </div>
...
<script src="<?= URL_RAIZ ?>js/usuarios/app-edit.js"></script>
