...
<div class="col-md-9 col-lg-10 ms-sm-auto px-4 main-content">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        ...
        <div class="action-buttons d-flex gap-2">
            <a href="<?= URL_RAIZ ?>view/usuarios/create.php" class="btn btn-primary rounded-0">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-bg-primary">Correo</th>
                            <th class="text-bg-primary">Role</th>
...
<script src="<?= URL_RAIZ ?>js/usuarios/app-index.js"></script>
